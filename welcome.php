...
<head>
    <meta charset="UTF-8">
    <title>Bienvenue sur MMI'Story</title>
...
<div class="navbar">
    ...
    <div class="nav-button__team">
        <a href="team.php"><img src="assets/img/header/bouton-portfolio.png" alt="Button Image" id="buttonImage"></a>
    </div>
</div>
...
<section class="container welcome">
    ...
    <div class="welcome-lines">
        ...
        <a href="parcours/1.php">👉 C'est parti !</a>
    </div>
</section>
